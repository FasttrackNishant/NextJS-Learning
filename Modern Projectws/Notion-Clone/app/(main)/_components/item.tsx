...
import { ChevronDown, ChevronRight, LucideIcon, MoreHorizontal, Plus, PlusIcon, Trash } from 'lucide-react'
...
export const Item = ({ label, onClick, icon: Icon, id, documentIcon, onExpand, isSearch, active, level = 0, expanded }: ItemsProps) => {
    ...
    return (
        <div
            ...
            {documentIcon ? <div className="shrink-0 mr-2 text-[18px]">{documentIcon}</div> : <Icon className="shrink-0 h-[18px] w-[18px] mr-2 text-muted-foreground" />}
