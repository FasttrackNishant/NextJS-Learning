...
const Navigation = () => {
    ...
    const handleMouseMove = (e: MouseEvent) => {
        ...
        if (newWidth > 4080) newWidth = 4080
    ...
    return (
        <>
            ...
            <div ref={navbarRef} className={cn('absolute top-0 z-[99999] left-60 w-[calc(100%-240)]', isResetting && 'transition-all ease-in-out duration-300', isMobile && 'left-0 w-full')}>
                {!!params.documentId ? (
